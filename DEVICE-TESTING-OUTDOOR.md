...
1. Grant "While Using the App" location access when prompted on first "Start
   Run." Lift does not ask for Always; a recording started on screen keeps
   running while locked, with the blue location indicator showing.
